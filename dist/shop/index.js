...
})({"hvPvg":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0f40280b87e69443";
"use strict";
...
},{}],"iGZp1":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    toPageTop();
    const splittWords = new (0, _splitTypeDefault.default)(".wave-text, .shop-items_content h4, .shop-items_content p, .section_info-shop h2, .section_info-shop p", {
        types: "lines, words"
    });
    ...
    function pageLoadMobile() {
        ...
        heroLoadTl.to(".wave-text .word", {
            ...
            scale: 0.99,
            duration: 1.5
        }, "<20%").to(".navbar1_component", {
            opacity: 1,
            y: "0%",
            duration: 1
        }, "<0%").to(".section_info-shop .line", {
            opacity: 1,
            duration: 1.4,
            rotateZ: 0,
    ...
    mm.add("(min-width: 700px)", ()=>{
        const infoShopTl = (0, _gsapDefault.default).timeline({
            scrollTrigger: {
        ...
        infoShopTl.to(".section_info-shop .line", {
            opacity: 1,
            duration: 1.4,
            rotateZ: 0,
            transformOrigin: "left top",
    ...
    twoColReveal.forEach((el)=>{
        ...
        revealTl.to(el.querySelector(".shop-image"), {
            opacity: 1,
            y: "0%",
            scale: 0.99,
            duration: 1.4
        }).to(el.querySelectorAll(".shop-items_content .line"), {
            opacity: 1,
            duration: 1.2,
            rotateZ: 0,
            transformOrigin: "left top",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hvPvg","iGZp1"], "iGZp1", "parcelRequirea718")
