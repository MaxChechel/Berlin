...
})({"11gPA":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "5a9ec510a80b06b4";
"use strict";
...
},{}],"jHaiW":[function(require,module,exports) {
...
(0, _gsap.gsap).registerPlugin((0, _scrollTriggerDefault.default), (0, _all.Flip));
...
function footerReveal() {
    imagesLoaded(".page-wrapper", ()=>{
        const footerTl = (0, _gsap.gsap).timeline({
            scrollTrigger: {
...
function pageAnimations() {
    const splittWords = new (0, _splitTypeDefault.default)("h1, .wave-text, .section_header h2, .section_header p", {
        types: "lines, words"
    });
    wrapLines("h1 .line");
    ...
    //Video reveal
    const vidRevealTl = (0, _gsap.gsap).timeline({
        scrollTrigger: {
    ...
    vidRevealTl.to(".video_lightbox-image", {
        opacity: 1,
        y: "0%",
        scale: 1,
        duration: 1.4
        ...
        opacity: 1,
        duration: 0.8
    }, "<30%").to("#custom-play-button", {
        opacity: 1,
        duration: 0.8
    }, "<0%");
    //Heading & cta reveal
    const headingRevealTl = (0, _gsap.gsap).timeline({
        scrollTrigger: {
    ...
    //Work
    const workRevealTl = (0, _gsap.gsap).timeline({
        scrollTrigger: {
    ...
    workRevealTl.to(".wave-text .word", {
        opacity: 1,
        duration: 0.6,
        y: "0%",
        rotateX: 0,
    ...
    //Header
    const headerRevealTl = (0, _gsap.gsap).timeline({
        scrollTrigger: {
    ...
    headerRevealTl.to(".section_header h2 .line", {
        opacity: 1,
        duration: 1.4,
        ease: "power4.out",
        y: "0%",
...
// ---- Main Load TL
let mainLoad = (0, _gsap.gsap).timeline();
function runAnimation() {
    const width = window.innerWidth;
    if (mainLoad) mainLoad.kill();
    mainLoad = (0, _gsap.gsap).timeline();
    ...
    if (width > 991) {
        ...
        mainLoad.to(navActions, {
            opacity: 1,
            ease: "power3.out",
            duration: 1
        }, "<");
        mainLoad.set(navLogo, {
            translateY: "10.4em"
        });
        mainLoad.set(navWrap, {
            css: {
                width: (0, _gsap.gsap).getProperty(".nav-spacer_logo-wrap", "width"),
                height: "auto",
                opacity: 1
            }
        });
        ...
        mainLoad.to(navSpacer, {
            css: {
                width: "auto",
                height: (0, _gsap.gsap).getProperty(".navbar1_container", "height"),
                opacity: 1
            },
            ease: defaultEase,
            duration: 1
        ...
        mainLoad.to(wrap, {
            width: (0, _gsap.gsap).getProperty(".navbar1_logo-wrap", "width"),
            ease: defaultEase,
            duration: 1
        }, "<");
        mainLoad.to(logo, {
...
function initScroll() {
    let tl1 = (0, _gsap.gsap).timeline({
        scrollTrigger: {
            ...
            end: `top ${(0, _gsap.gsap).getProperty(".navbar1_container", "height")}`,
            scrub: 0.5,
            ease: "linear"
        }
    });
    ...
    tl1.to(navWrap, {
        css: {
            width: (0, _gsap.gsap).getProperty(".navbar1_logo-link", "width"),
            opacity: 1
        }
    }, "<");
    /* Nav Fixed */ let tl2 = (0, _gsap.gsap).timeline({
        scrollTrigger: {
            trigger: ".section_ticker",
            start: `top ${(0, _gsap.gsap).getProperty(".navbar1_container", "height")}`,
            onEnter: ()=>{
                (0, _gsap.gsap).set(navbar, {
                    position: "absolute",
                    top: ()=>{
                        const offsetTop = document.querySelector(".section_ticker").getBoundingClientRect().top + window.scrollY;
                        const navbarHeight = (0, _gsap.gsap).getProperty(".navbar1_container", "height"); // Adjust '.navbar' if your selector is different
    ...
    function getMaxWidthForBreakpoint() {
        const width = window.innerWidth;
        if (width > 767) return "15rem";
        if (width > 479) return "13rem";
        if (width > 0) return "10rem";
        return "17rem";
    }
}
// ---- Resize Logic
...
},{"gsap":"fPSuC","gsap/all":"3UJRo","gsap/src/ScrollTrigger":"3fjnC","split-type":"fvGAG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3UJRo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TweenLite", ()=>(0, _gsapCoreJs.TweenLite));
parcelHelpers.export(exports, "TimelineMax", ()=>(0, _gsapCoreJs.TimelineMax));
...
},{"./gsap-core.js":"05eeC","./CSSPlugin.js":"l02JQ","./CustomEase.js":false,"./Draggable.js":"2Y3tI","./CSSRulePlugin.js":false,"./EaselPlugin.js":false,"./EasePack.js":false,"./Flip.js":"iKp6p","./MotionPathPlugin.js":false,"./Observer.js":false,"./PixiPlugin.js":false,"./ScrollToPlugin.js":false,"./ScrollTrigger.js":false,"./TextPlugin.js":false,"./DrawSVGPlugin.js":false,"./Physics2DPlugin.js":false,"./PhysicsPropsPlugin.js":false,"./ScrambleTextPlugin.js":false,"./CustomBounce.js":false,"./CustomWiggle.js":false,"./GSDevTools.js":false,"./InertiaPlugin.js":false,"./MorphSVGPlugin.js":false,"./MotionPathHelper.js":false,"./ScrollSmoother.js":false,"./SplitText.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2Y3tI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./utils/matrix.js":"khPcO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3fjnC":[function(require,module,exports) {
/*!
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["11gPA","jHaiW"], "jHaiW", "parcelRequirea718")
