...
})({"uVerc":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ef811b08466a7b3b";
"use strict";
...
},{}],"f9SF0":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    function pageLoadTl() {
        ...
        heroLoadTl.to(".featured-image", {
            opacity: 1,
            y: "0%",
            scale: 1,
            duration: 1.5
        }).to(".featured-title .text-style-allcaps", {
            opacity: 1,
            duration: 0.8,
            rotateZ: 0,
            transformOrigin: "left top",
            y: "0%"
        }, "<20%").to(".latest-title .line", {
            opacity: 1,
            duration: 0.8,
            rotateZ: 0,
            transformOrigin: "left top",
            ...
            display: "block",
            duration: 0
        }, "<50%").to(".featured-latest-item", {
            pointerEvents: "all",
            duration: 0
        }, "<").to(".filter_component-dark", {
            opacity: 1,
            y: "0%",
            duration: 1
        }, "<0%").to(".latest-grid-item", {
            opacity: 1,
            duration: 1,
            stagger: {
                each: 0.05
            }
        }).to(".navbar1_component", {
            opacity: 1,
            y: "0%",
            duration: 1
        }, "<0%");
    ...
    if (windowHeight < 840) {
        ...
        latestCards.forEach((el)=>{
            const latestCardsTl = (0, _gsapDefault.default).timeline({
                scrollTrigger: {
                    trigger: el,
                    start: "top 60%",
                    end: "top 40%"
        ...
        const paginationTl = (0, _gsapDefault.default).timeline({
            scrollTrigger: {
                trigger: ".pagination",
                start: "top 75%",
                end: "top 40%"
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["uVerc","f9SF0"], "f9SF0", "parcelRequirea718")
