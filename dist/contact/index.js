...
})({"hnGXV":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c3e5b9f4303dc2b8";
"use strict";
...
},{}],"aXXYo":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    toPageTop();
    const splittWords = new (0, _splitTypeDefault.default)(".wave-text, h1", {
        types: "lines, words"
    });
    wrapLines("h1 .line");
    ...
    function pageLoadTl() {
        ...
        heroLoadTl.to(".wave-text .word", {
            ...
            y: "0%"
        }, "<20%").to(".contact_content-text span", {
            opacity: 1,
            duration: 1,
            stagger: {
                each: 0.025
            }
        }, "<50%").to(".navbar1_component", {
            opacity: 1,
            y: "0%",
            duration: 1
        }, "<0%").to(".footer_logo-link", {
            y: "0%",
            opacity: 1,
            ease: "power4.inOut",
            duration: 1.8
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hnGXV","aXXYo"], "aXXYo", "parcelRequirea718")
