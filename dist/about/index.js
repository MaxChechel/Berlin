...
})({"iI6Op":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0e2e7348dcb9382e";
"use strict";
...
},{}],"hpiDY":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const splitChars = new (0, _splitTypeDefault.default)("[data-text-fade-in]", {
    ...
    function loaderSimple() {
        ...
        const loaderTl = (0, _gsapDefault.default).timeline();
    ...
    fadeInText.forEach((text)=>{
        const textTl = (0, _gsapDefault.default).timeline({
            scrollTrigger: {
                trigger: text,
                start: "top 70%",
                end: "top 40%",
    ...
    twoColReveal.forEach((el)=>{
        const revealTl = (0, _gsapDefault.default).timeline({
            scrollTrigger: {
                trigger: el,
                start: "top 60%",
                end: "top 40%"
        ...
        revealTl.to(el.querySelector(".about_image"), {
            opacity: 1,
            y: "0%",
            scale: 1,
            duration: 1.4
        }).to(el.querySelectorAll(".about_heading .line"), {
            opacity: 1,
            duration: 0.8,
            rotateZ: 0,
            transformOrigin: "left top",
    ...
    //Shop
    const shopTl = (0, _gsapDefault.default).timeline({
        scrollTrigger: {
    ...
    shopTl.to(".section_layout-shop img", {
        opacity: 1,
        y: "0%",
        scale: 1,
        duration: 1.4
    }).to(".section_layout-shop p", {
        opacity: 1,
        duration: 0.8,
        rotateZ: 0,
        transformOrigin: "left top",
        y: "0%"
    }, 0).to(".section_layout-shop h2 .line", {
        opacity: 1,
        duration: 0.8,
        rotateZ: 0,
        transformOrigin: "left top",
    ...
    }, "<0%").to(".section_layout-shop .button-group", {
        opacity: 1,
        duration: 0.8
    }, "<80%");
    //Values
    ...
    valuesContainers.forEach((el)=>{
        const valuesTl = (0, _gsapDefault.default).timeline({
            scrollTrigger: {
                trigger: el,
                start: "top 60%",
                end: "top 40%"
        ...
        valuesTl.to(el.querySelector(".values-wave"), {
            x: "0%",
            duration: 0.8
        }).to(el.querySelectorAll(".section_values .heading-style-h5"), {
            opacity: 1,
            duration: 0.8,
            stagger: {
                each: 0.1
            }
        }, "<30%").to(el.querySelectorAll(".section_values h4 .line"), {
            opacity: 1,
            duration: 0.8,
            rotateZ: 0,
            transformOrigin: "left top",
    ...
    (function() {
        (0, _gsapDefault.default).set(cursor, {
            xPercent: -50,
            yPercent: -50
        });
    ...
    const teamTl = (0, _gsapDefault.default).timeline({
        scrollTrigger: {
    ...
    teamTl.to(".section_team h3 .word", {
        opacity: 1,
        duration: 0.8,
        rotateZ: 0,
        transformOrigin: "left top",
    ...
    }).to(".section_team .heading-style-h4 .line", {
        opacity: 1,
        duration: 0.8,
        rotateZ: 0,
        transformOrigin: "left top",
    ...
    //Jobs
    const jobsTl = (0, _gsapDefault.default).timeline({
        scrollTrigger: {
    ...
    jobsTl.to(".section_jobs h3 .word", {
        opacity: 1,
        duration: 0.8,
        rotateZ: 0,
        transformOrigin: "left top",
    ...
    //Clients
    const clientsTl = (0, _gsapDefault.default).timeline({
        scrollTrigger: {
    ...
    jobsTl.to(".section_clients h3 .word", {
        opacity: 1,
        duration: 0.8,
        rotateZ: 0,
        transformOrigin: "left top",
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3fjnC":[function(require,module,exports) {
/*!
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3UJRo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TweenLite", ()=>(0, _gsapCoreJs.TweenLite));
parcelHelpers.export(exports, "TimelineMax", ()=>(0, _gsapCoreJs.TimelineMax));
...
},{"./utils/matrix.js":"khPcO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iI6Op","hpiDY"], "hpiDY", "parcelRequirea718")
