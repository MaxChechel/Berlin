...
})({"cob26":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "436257427c0fa1f2";
"use strict";
...
},{}],"hDrdx":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    const splittWords = new (0, _splitTypeDefault.default)(".wave-text, h1, .positions_content h2, .section_positions h3, .positions-items h4, .careers_component .positions_content p, [data-positions='text']", {
        types: "lines, words"
    });
    wrapLines("h1 .line");
    ...
    function pageLoadTl() {
        ...
        }, "<10%").to(".positions_content h2 .line", {
            opacity: 1,
            duration: 0.8,
            rotateZ: 0,
            transformOrigin: "left bottom",
        ...
        }, "<20%").to(".careers_component .positions_content:first-child p .line", {
            opacity: 1,
            duration: 1.6,
            ease: "power4.out",
            stagger: {
        ...
        }, "<10%").to(".careers_component .positions_content:last-child p .line", {
            opacity: 1,
            duration: 1.6,
            ease: "power4.out",
            stagger: {
    ...
    jobPosts.forEach((el)=>{
        ...
        const jobPostsTl = (0, _gsapDefault.default).timeline({
            scrollTrigger: {
                trigger: el,
                start: "top 60%",
                end: "top 40%"
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cob26","hDrdx"], "hDrdx", "parcelRequirea718")
